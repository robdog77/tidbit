...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
        KC_MUTE,   KC_PSLS, KC_PAST,
  KC_7, KC_8,     KC_9, KC_PMNS,
  KC_4, KC_5,     KC_6, KC_PPLS,
  KC_1, KC_2,     KC_3, KC_ENT,
  MO(1), KC_0, KC_DOT, KC_ENT
  ),

  [_VIA1] = LAYOUT(
           KC_MPLY, KC_TRNS, KC_DEL,
  KC_HUI, KC_TRNS, KC_MOD, KC_VAI,
  KC_HUD, KC_UP, KC_RMOD, KC_VAD,
  KC_LEFT, KC_DOWN, KC_RIGHT, KC_TOG,
